...
import SwiftyJSON
import CoreData
class lasx2ViewController: UIViewController {
    ...
    var teamtwon = ""
    var localIp = ""
    @IBAction func xajout(_ sender: Any) {
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue("X", forKey: "taamira")
    ...
    @IBAction func lasajout(_ sender: Any) {
        let userid = UserDefaults.standard.string(forKey: "iduserr")
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let managedContext = appDelegate.persistentContainer.viewContext
        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Tammir")
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue(teamonen, forKey: "team1")
                user.setValue(teamtwon, forKey: "team2")
                user.setValue("1", forKey: "taamira")
                user.setValue(userid, forKey: "userid")
                print("hi")
    ...
    @IBAction func douajout(_ sender: Any) {
        let userid = UserDefaults.standard.string(forKey: "iduserr")
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let managedContext = appDelegate.persistentContainer.viewContext
        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Tammir")
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue(teamonen, forKey: "team1")
                user.setValue(teamtwon, forKey: "team2")
                user.setValue("2", forKey: "taamira")
                user.setValue(userid, forKey: "userid")
                print("hi")
            ...
            if let json1 = response.result.value {
                ...
                for var2 in  var1 {
                    ...
                    if( String(describing: string3) == self.teamonen && String(describing: string4) == self.teamtwon){
                        ...
                        self.dou.text = douu
                        self.x.text = xx
                       // self.overuncinq.text = over1
                        //self.underuncinq.text = under1
                       /// self.overdeuxcinq.text = over2
                       // self.underdeuxcinq.text = under2
                       // self.gg.text = gg
                        //self.ng.text = ng
