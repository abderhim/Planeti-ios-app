...
class overViewController: UIViewController {
    ...
    @IBOutlet weak var overone: UILabel!
    
    @IBOutlet weak var undertwo: UILabel!
    @IBOutlet weak var overtwo: UILabel!
    @IBOutlet weak var underone: UILabel!
    @IBAction func overone(_ sender: Any) {
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue("Over 1.5", forKey: "taamira")
    ...
    @IBAction func underone(_ sender: Any) {
        let userid = UserDefaults.standard.string(forKey: "iduserr")
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let managedContext = appDelegate.persistentContainer.viewContext
        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Tammir")
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue(teamonen, forKey: "team1")
                user.setValue(teamtwon, forKey: "team2")
                user.setValue("Under 1.5", forKey: "taamira")
                user.setValue(userid, forKey: "userid")
                print("hi")
    ...
    @IBAction func undertwo(_ sender: Any) {
        let userid = UserDefaults.standard.string(forKey: "iduserr")
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let managedContext = appDelegate.persistentContainer.viewContext
        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Tammir")
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue(teamonen, forKey: "team1")
                user.setValue(teamtwon, forKey: "team2")
                user.setValue("Under 2.5", forKey: "taamira")
                user.setValue(userid, forKey: "userid")
                print("hi")
    ...
    @IBAction func overtwo(_ sender: Any) {
        let userid = UserDefaults.standard.string(forKey: "iduserr")
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let managedContext = appDelegate.persistentContainer.viewContext
        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Tammir")
        ...
        do{
            ...
            if count == 0
            {
                ...
                user.setValue(teamonen, forKey: "team1")
                user.setValue(teamtwon, forKey: "team2")
                user.setValue("Over 2.5", forKey: "taamira")
                user.setValue(userid, forKey: "userid")
                print("hi")
